	...
	return (
		<div>
			<section id="healthIntro">
				<div class="container">
					<div id="healthIntro_text" class="fade-in">
						<h2>Health</h2>
					...
					<a href="#healthContent"><img class="downArrow" src="https://image.flaticon.com/icons/svg/2316/2316598.svg" /></a>
				</div>
			</section>

			<section id="healthContent">
				<div class="container">
					<div id="healthInfo" class="overflow-container">
						<h3>EMERGENCIES</h3>
						<div class="slideDown">
							<ul>
						...
						<h4>Care for Your Mental Health:</h4>
						...
						<h4>Get your body moving:</h4>
						<p id="warning">(No Equipment Needed)</p>
						<div class="slideDown" id="physicalLinks">
							<ul>
